...
const ErorModal = ({setError}) => {
  return (
    <div className="absolute z-50 bg-slate-400 bg-opacity-40 w-[99vw] h-screen flex justify-center items-center">
      <div class="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-[350px] h-[200px] flex items-center justify-center rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-[300px]">
        <div class="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
          ...
          <h5 class="text-[25px] font-semibold mb-2 text-left mr-auto text-zinc-700">
           The password or Email entered incorrected!!!
          </h5>
          ...
          <button onClick={() => setError(false)}
            class=" font-semibold cursor-pointer py-2 px-8 w-max break-keep text-sm rounded-lg transition-colors text-[#634647] hover:text-[#ddad81] bg-[#ddad81] hover:bg-[#634647]"
            type="button"
          >
            Accept
          </button>
